    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 25, 8, 543);
    			attr_dev(h3, "class", "card-text svelte-im00ab");
    			add_location(h3, file$2, 27, 12, 646);
    			attr_dev(p, "class", "card-text");
    			add_location(p, file$2, 28, 12, 692);
    			attr_dev(div0, "class", "card-body");
    			add_location(div0, file$2, 26, 8, 610);
    			attr_dev(div1, "onclick", div1_onclick_value = "window.location='" + /*href*/ ctx[4] + "'");
    			attr_dev(div1, "class", "card mb-4 shadow-sm");
    			add_location(div1, file$2, 24, 4, 466);
    			...
    			add_location(div2, file$2, 23, 0, 371);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div2, file$3, 32, 4, 632);
    			...
    			add_location(div3, file$3, 31, 0, 537);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link0, file$4, 19, 4, 471);
    			...
    			add_location(link1, file$4, 23, 4, 616);
    			script0.defer = true;
    			...
    			add_location(script0, file$4, 30, 4, 893);
    			script1.defer = true;
    			...
    			add_location(script1, file$4, 36, 4, 1122);
    			script2.defer = true;
    			...
    			add_location(script2, file$4, 42, 4, 1370);
    			attr_dev(div0, "class", "row mb-2");
    			add_location(div0, file$4, 55, 8, 1809);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$4, 54, 4, 1783);
    			attr_dev(div2, "class", "container svelte-424vga");
    			add_location(div2, file$4, 53, 0, 1755);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
